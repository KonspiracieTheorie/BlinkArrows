...
[CustomArrows("ArrowBombArrows", "CreateGraphicPickup")]
public class ArrowBombArrow : Arrow
{
    ...
    public static ArrowInfo CreateGraphicPickup()
    {
        ...
        var arrowInfo = ArrowInfo.Create(graphic, ExampleArrowModModule.ArrowBombAtlas["ArrowBombArrowHud"]);
    ...
    {
        normalImage = new Image(ExampleArrowModModule.ArrowBombAtlas["ArrowBombArrow"]);
        normalImage.Origin = new Vector2(13f, 3f);
        buriedImage = new Image(ExampleArrowModModule.ArrowBombAtlas["ArrowBombArrowBuried"]);
