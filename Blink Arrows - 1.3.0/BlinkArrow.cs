...
[CustomArrows("BlinkArrow", "CreateGraphicPickup")]
public class BlinkArrow : Arrow
{
    ...
    {
        var graphic = new Sprite<int>(KonspiracieArrowsModModule.ArrowAtlas["BlinkArrowPickup"], 12, 12, 0);
        graphic.CenterOrigin();
        var arrowInfo = ArrowInfo.Create(graphic, KonspiracieArrowsModModule.ArrowAtlas["BlinkArrowHud"]);
    ...
    {
        normalImage = new Image(KonspiracieArrowsModModule.ArrowAtlas["BlinkArrow"]);
        normalImage.Origin = new Vector2(13f, 3f);
        buriedImage = new Image(KonspiracieArrowsModModule.ArrowAtlas["BlinkArrowBuried"]);
