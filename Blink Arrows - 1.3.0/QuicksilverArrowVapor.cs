...
public class QuicksilverArrowDrip : Arrow
{
    ...
    public static ArrowInfo CreateGraphicPickup()
    {
        ...
        var arrowInfo = ArrowInfo.Create(graphic, KonspiracieArrowsModModule.ArrowAtlas["QuicksilverArrowDripHud"]);
    ...
    {
        normalImage = new Image(KonspiracieArrowsModModule.ArrowAtlas["QuicksilverArrowDrip"]);
        normalImage.Origin = new Vector2(13f, 3f);
        buriedImage = new Image(KonspiracieArrowsModModule.ArrowAtlas["QuicksilverArrowDripBuried"]);
