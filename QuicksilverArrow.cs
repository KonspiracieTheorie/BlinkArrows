...
[CustomArrows("QuicksilverArrows", "CreateGraphicPickup")]
public class QuicksilverArrow : Arrow
{
    ...
    public static ArrowInfo CreateGraphicPickup()
    {
        ...
        var arrowInfo = ArrowInfo.Create(graphic, ExampleArrowModModule.QuicksilverAtlas["QuicksilverArrowHud"]);
    ...
    {
        normalImage = new Image(ExampleArrowModModule.QuicksilverAtlas["QuicksilverArrow"]);
        normalImage.Origin = new Vector2(13f, 3f);
        buriedImage = new Image(ExampleArrowModModule.QuicksilverAtlas["QuicksilverArrowBuried"]);
