...
public class SublimeArrowVapor : Arrow
{
    ...
    public static ArrowInfo CreateGraphicPickup()
    {
        ...
        var arrowInfo = ArrowInfo.Create(graphic, ExampleArrowModModule.SublimeAtlas["SublimeArrowVaporHud"]);
    ...
    {
        normalImage = new Image(ExampleArrowModModule.SublimeAtlas["SublimeArrowVapor"]);
        normalImage.Origin = new Vector2(13f, 3f);
        buriedImage = new Image(ExampleArrowModModule.SublimeAtlas["SublimeArrowVaporBuried"]);
